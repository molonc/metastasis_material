...
def main(library_id, cache_folder, container='rdatarawv3'):
    ...
    blobs_all = blob_service.list_blobs(container) #rdatarawv3, rdatav3
...
if __name__ == "__main__":
    ...
    main(args['library_id'], args['download_dir'],'rdatarawv3')
