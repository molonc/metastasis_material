...
input_dir=/home/htran/storage/datasets/drug_resistance/rna_results/SA609_rna/TreeAlign_testing/
save_dir="${input_dir}/TreeAlign_result_thrs08/"
...
meta_sample_ids="${input_dir}/samples_run_list.txt"
...
do
  ...
  expr_fn="${input_dir}${datatags[n]}_expr.csv.gz"
