## Author: Hoa Tran
## Based on leiden clustering algo, and igraph python package
...
## Example how to run scripts from snakemake rule: 
## You can run script files from command line 

## First converting from newick format to graphml format that python igraph can read
