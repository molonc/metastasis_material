...
def downsampling(data_df, percentds = 0.2):
...
#         filtered_state_data_ds = downsampling(filtered_state_data, 0.05)
#         print("dimensions of downsample filtered data", filtered_state_data_ds.shape)
