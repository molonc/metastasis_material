...
launch_run <- function(tree, copy_number, 
                       grouping_file='library_groupings.csv',save_dir='', 
                       minimum_fraction=0.02,maximum_fraction=0.65,clone_size_threshold, 
                       edge_diff_threshold, adjust_ploidy, prob, min_merge_back_fraction) {
    desc <- paste0('if_',minimum_fraction,'_af_',maximum_fraction,'_p',prob,'_e',edge_diff_threshold)
    print(desc)
    ...
    write.table(cell_clones, paste0(save_dir, 'cell_clones_',desc,'.csv'), quote = FALSE, sep = ",", row.names = FALSE)
