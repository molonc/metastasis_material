...
launch_run <- function(newick, copynumber, output, minimum_fraction, maximum_fraction,clone_size_threshold, edge_diff_threshold, adjust_ploidy, prob, min_merge_back_fraction) {
    ...
    write.table(cell_clones, output, quote = FALSE, sep = ",", row.names = FALSE)
    print("DONE!!")
}
