...
def filter_libs(**kwargs):
    ...
    quality_thrs = kwargs['thrs_quality'] #0.75
    # quality_thrs = 0.5
    ...
    ## Disable cell/nuclei filtering metric for this project. 
...
#     excl = ['NCC','A-NCC','NTC','gDNA']
#     if excl:
#         print(excl)
#         filtered_metrics = filtered_metrics[(~filtered_metrics["experimental_condition"].isin(excl))]
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--thrs_quality', required=False, default='0.75')
    ...
    # thrs_quality = float(args['thrs_quality'])
    # # print(output_file)
    # print('library id: {0}'.format(library_id))
    # print('samples: {0}'.format(samples))
    # print('thrs_map_reads {0}'.format(thrs_map_reads))
    # print('thrs_quality {0}'.format(thrs_quality))
    # filter_libs(library_id=library_id, samples=samples, metrics=metrics,
    #             reads=reads, output_file=output_file,
    #             thrs_map_reads=thrs_map_reads, thrs_quality=thrs_quality) #cell_state_predict=cell_state_predict,
                
    ## For many library ids, load library id, and sample id from command line
    meta_fn = '/home/htran/Projects/hakwoo_project/metastasis_material/materials/dlp_trees/SA535/jira_tickets_library_groupings_M1_M3_M4.csv.gz'
    download_dir = '/home/htran/storage/raw_DLP/metastasis_DLP/SA535/'
    save_dir = '/home/htran/storage/datasets/metastasis_results/replication_timing/'
    ...
    for i in range(lib_df.shape[0]): #
          ...
          metrics_fn1 = os.path.join(download_dir,library_id,'annotation','metrics.csv.gz')
          metrics_fn2 = os.path.join(download_dir,library_id,'annotation',library_id + '_metrics.csv.gz')
          ...
          print(metrics)                  
          reads_fn1 = os.path.join(download_dir,library_id,'hmmcopy','reads.csv.gz')
          reads_fn2 = os.path.join(download_dir,library_id,'hmmcopy',library_id +'_reads.csv.gz')
          ...
          print(reads)                                   
          thrs_map_reads = int('10000') # For SA535
          thrs_quality = 0.5 #float('0.5')
          output_file = os.path.join(save_dir,library_id+'_filtered_states.csv.gz')
          filter_libs(library_id=library_id, samples=samples, metrics=metrics,
                reads=reads, output_file=output_file,
                thrs_map_reads=thrs_map_reads, thrs_quality=thrs_quality)



## How to run this function from command line mode: 
## /home/htran/anaconda3/envs/sisyphus/bin/python filter_libs_modified.py --library_id A98166A --samples AT11367 --metrics /home/htran/storage/raw_DLP/metastasis_DLP/A98166A/annotation/A98166A_metrics.csv.gz --reads /home/htran/storage/raw_DLP/metastasis_DLP/A98166A/hmmcopy/A98166A_reads.csv.gz --output_file /home/htran/storage/datasets/metastasis_results/dlp_SA919_mixing_exp/A98166A_filtered_states.csv --thrs_map_reads 500000
## /home/htran/anaconda3/envs/sisyphus/bin/python filter_libs_modified.py --library_id A98166B --samples AT11391 --metrics /home/htran/storage/raw_DLP/metastasis_DLP/A98166B/annotation/A98166B_metrics.csv.gz --reads /home/htran/storage/raw_DLP/metastasis_DLP/A98166B/hmmcopy/A98166B_reads.csv.gz --output_file /home/htran/storage/datasets/metastasis_results/dlp_SA919_mixing_exp/A98166B_filtered_states.csv --thrs_map_reads 500000
## 
## /home/htran/anaconda3/envs/sisyphus/bin/python filter_libs_replication_timing.py --library_id A130854B --samples AT13696 --metrics /home/htran/storage/raw_DLP/metastasis_DLP/SA919/A130854B/annotation/metrics.csv.gz --reads /home/htran/storage/raw_DLP/metastasis_DLP/SA919/A130854B/hmmcopy/reads.csv.gz --output_file /home/htran/storage/datasets/metastasis_results/dlp_SA919_mixing_exp/A130854B_filtered_states.csv --thrs_map_reads 10000 --thrs_quality 0
